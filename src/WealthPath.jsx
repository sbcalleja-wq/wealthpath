...
const ALL_ASSETS = [
  ...
  { ticker: "JNJ", name: "Johnson & Johnson", type: "Stock", sector: "Healthcare", expReturn: 0.075, vol: 0.14, div: 0.03, er: 0, color: "#D4A2A2" },
  ...
  { ticker: "MSFT", name: "Microsoft", type: "Stock", sector: "Technology", expReturn: 0.12, vol: 0.22, div: 0.008, er: 0, color: "#D9C4A2", inside: { top: ["Azure cloud, Office 365, Windows, AI"], role: "Enterprise software king + AI integration" }},
  ...
  { ticker: "V", name: "Visa Inc.", type: "Stock", sector: "Financials", expReturn: 0.11, vol: 0.18, div: 0.008, er: 0, color: "#B8B0D9", inside: { top: ["Processes ~$15 trillion/year globally"], role: "Toll booth on global spending" }},
  ...
  { ticker: "LLY", name: "Eli Lilly", type: "Stock", sector: "Healthcare", expReturn: 0.14, vol: 0.28, div: 0.008, er: 0, color: "#D9C48A", inside: { top: ["Mounjaro/Zepbound (GLP-1)", "Alzheimer's treatments"], role: "GLP-1 drug boom — fastest-growing drugs in history" }},
  { ticker: "BRK.B", name: "Berkshire Hathaway", type: "Stock", sector: "Diversified", expReturn: 0.10, vol: 0.17, div: 0, er: 0, color: "#A2B8D4", inside: { top: ["GEICO, BNSF Railway, massive stock portfolio"], role: "Buffett's conglomerate — like a fund run by the GOAT" }},
